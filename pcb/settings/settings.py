"""
Django settings for pcb project.
...
SECRET_KEY = params.get('app', 'secret_key')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = params.getboolean('app', 'debug')
...
WSGI_APPLICATION = 'pcb.wsgi.application'
